...
def main(individual_size: int,
    ...
    save_model(trained_population, filepath="model1.pkl")
    print(f"Программа завершена за {time.time() - start_time:.2f} секунд.")


if __name__ == "__main__":
    main(individual_size = 3,  # признаки
         population_size = 250,  # популяция
         iterations = 1_000_000,  # количество итераций
         clone_count = 70,  # количество клонов
